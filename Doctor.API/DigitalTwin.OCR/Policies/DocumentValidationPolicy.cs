...
public static class DocumentValidationPolicy
{
    ...
    {
        [DocumentMimeType.Pdf] = [new byte[] { 0x25, 0x50, 0x44, 0x46 }],           // %PDF
        [DocumentMimeType.Jpeg] = [new byte[] { 0xFF, 0xD8, 0xFF }],                // JFIF / EXIF
        [DocumentMimeType.Png] = [new byte[] { 0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A }] // ‰PNG
    };
