...
RESOURCES_DIR="Mobile/DigitalTwin.Mobile.OCR/Resources/Models"
...
echo "    Mobile/DigitalTwin.Mobile.OCR/Resources/Models/doc_type_classifier_v1.mlmodelc/"
echo "    Mobile/DigitalTwin.Mobile.OCR/Resources/Models/reference_feature_prints.json"
echo "    models/manifest.json"
echo ""
echo "  models/output/ is gitignored (temp build artefacts)."
echo ""
echo "  Commit with:"
echo "    git add Mobile/DigitalTwin.Mobile.OCR/Resources/Models/ models/manifest.json"
